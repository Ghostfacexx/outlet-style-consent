...
export default function ShopMensBags() {
  const bagProducts = mensProducts.filter(product => product.category === "bags");

  return (
    <>
      <Helmet>
        <title>Men's Designer Bags | THE OUTNET</title>
        <meta name="description" content="Shop luxury men's designer bags at up to 70% off. Discover briefcases, backpacks, messenger bags from top fashion brands." />
        <link rel="canonical" href="/shop/mens/bags" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Carry your essentials in style with luxury designer bags at unbeatable prices.
            </p>
          </div>
          ...
          {bagProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600">No bag products available at the moment.</p>
