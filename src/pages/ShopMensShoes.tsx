...
export default function ShopMensShoes() {
  const shoeProducts = mensProducts.filter(product => product.category === "shoes");

  return (
    <>
      <Helmet>
        <title>Men's Designer Shoes | THE OUTNET</title>
        <meta name="description" content="Shop luxury men's designer shoes at up to 70% off. Discover sneakers, boots, loafers from top fashion brands." />
        <link rel="canonical" href="/shop/mens/shoes" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Step up your style with luxury designer footwear at unbeatable prices.
            </p>
          </div>
          ...
          {shoeProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600">No shoe products available at the moment.</p>
